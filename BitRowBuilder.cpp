...
BitRowBuilder::BitRowBuilder() { row = EMPTYROW; }
...
int BitRowBuilder::getRow() { return row; }

void BitRowBuilder::reset() { row = EMPTYROW; }
...
void BitRowBuilder::inplaceReverse() { row = GetReverse(row); }
